...
import { getAllUsers, getStats, getStores, getUserById, getUsers, registerStore } from '../controllers/admin.controller.js'
...
adminRouter.post('/stores',authenticate,authorize("ADMIN"),registerStore)
